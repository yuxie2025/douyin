...
public class Utils {
    ...
    public static String post(String url, String params, boolean isJson) {
        return post(url, params, "", isJson);
    }
     ...
     * @throws IOException
     */
    public static String post(String url, String params, String token, boolean isJson) {
        ...
        try {
            ...
            conn.setRequestProperty("X-Requested-With", "com.sylife");
