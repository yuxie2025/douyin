...
public class UpdateDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        TextView tvUpdateContent = contentView.findViewById(R.id.tv_update_content);
        TextView tvVersion = titleView.findViewById(R.id.tv_version);
        ...
        if (!TextUtils.isEmpty(apkVersionModel.getAppVersion())) {
