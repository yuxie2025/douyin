...
public class LoadingView extends View {
    ...
    public LoadingView(Context context, AttributeSet attrs) {
        this(context, attrs, com.qmuiteam.qmui.R.attr.QMUILoadingStyle);
    }

    public LoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        @SuppressLint("CustomViewStyleable") TypedArray array = getContext().obtainStyledAttributes(attrs, R.styleable.Loading, defStyleAttr, 0);
        mSize = array.getDimensionPixelSize(R.styleable.Loading_loading_view_size, QMUIDisplayHelper.dp2px(context, 32));
        mPaintColor = array.getInt(R.styleable.Loading_loading_view_color, Color.WHITE);
        array.recycle();
        initPaint();
    }
    ...
    private ValueAnimator.AnimatorUpdateListener mUpdateListener = (ValueAnimator animation) -> {
