...
public class StarBar extends View {
    ...
    private boolean integerMark = true;  //星星数量是否是整数型的
    ...
    private void init(Context context, AttributeSet attrs) {
        setClickable(true);
        @SuppressLint("CustomViewStyleable") TypedArray mTypedArray = context.obtainStyledAttributes(attrs, R.styleable.RatingBar);
     ...
     * 设置监听
     *
     * @param onStarChangeListener 状态变化监听
     */
    ...
    public void setClisk(boolean clisk) {
        isClisk = clisk;
    }
}
